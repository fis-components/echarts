...
module.exports = DataZoomView.extend({
    ...
    _resetLocation: function () {
        ...
        zrUtil.each(layout.getLayoutParams(dataZoomModel.option), function (value, name) {
            if (value !== 'auto') {
 ...
 : info.otherDim;
    ...
    _resetInterval: function () {
        ...
        this._handleEnds = linearMap(range, [
            0,
            100
        ], this._getViewExtent(), true);
    },
    /**
         * @private
    ...
    _updateInterval: function (handleIndex, delta) {
        ...
        this._range = asc(linearMap(handleEnds, viewExtend, [
            0,
            100
        ], true));
    },
    ...
    _formatLabel: function (value, axis) {
        ...
        value = value == null && isNaN(value) ? ''    // FIXME Glue code
