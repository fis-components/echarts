        ...
        if (!createdBySelf) {
            ...
            ecModel.eachSeries(function (seriesModel) {
                ...
                if (!mlModel) {
                    ...
                    mlModel = new MarkLineModel(markLineOpt, this, ecModel, opt, true);
                } else {
    ...
    defaultOption: {
        ...
        label: {
            normal: {
                ...
                position: 'end'    // 默认使用全局文本样式，详见TEXTSTYLE
                         // textStyle: null
            },
            emphasis: { show: true }
        },
        lineStyle: {
            normal: {
                // color
                // width
                type: 'dashed'    // shadowColor: 'rgba(0,0,0,0)',
                            // shadowBlur: 0,
                            // shadowOffsetX: 0,
                            // shadowOffsetY: 0
            },
...
module.exports = MarkLineModel || module.exports;;