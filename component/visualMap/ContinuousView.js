...
var ContinuousVisualMapView = VisualMapView.extend({
    ...
    _resetInterval: function () {
        ...
        this._handleEnds = linearMap(dataInterval, visualMapModel.getExtent(), [
            0,
    ...
    _updateInterval: function (handleIndex, delta) {
        ...
        this._dataInterval = linearMap(handleEnds, [
            0,
            visualMapModel.itemSize[1]
        ], visualMapModel.getExtent(), true);
    },
    /**
         * @private
         */
...
module.exports = ContinuousVisualMapView || module.exports;;