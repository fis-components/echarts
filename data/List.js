...
listProto.initData = function (data, nameList, dimValueGetter) {
    ...
    dimValueGetter = dimValueGetter || function (dataItem, dimName, dataIndex, dimIndex) {
        ...
        return modelUtil.converDataValue(zrUtil.isArray(value) ? value[dimIndex]    // If value is a single number or something else not array.
...
listProto.get = function (dim, idx, stack) {
    ...
    if (stack && dimensionInfo && dimensionInfo.stackable) {
        ...
        while (stackedOn) {
            ...
            if (value >= 0 && stackedValue > 0 || value <= 0 && stackedValue < 0    // Negative stack
) {
                value += stackedValue;
            }
