...
lineProto._updateCommonStl = function (lineData, fromData, toData, idx) {
    ...
    label.setStyle({
        text: labelModel.get('show') ? seriesModel.getFormattedLabel(idx, 'normal') || defaultText : '',
        textFont: textStyleModel.getFont(),
        fill: textStyleModel.getTextColor() || lineData.getItemVisual(idx, 'color')
    });
    label.hoverStyle = {
        text: labelHoverModel.get('show') ? seriesModel.getFormattedLabel(idx, 'emphasis') || defaultText : '',
        textFont: textStyleModel.getFont(),
