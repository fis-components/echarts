...
Single.prototype = {
    ...
    _init: function (axisModel, ecModel, api) {
        ...
        var axis = new SingleAxis(dim, axisHelper.createScaleByModel(axisModel), [
            0,
            0
        ], axisModel.get('type'), axisModel.position);
    ...
    dataToPoint: function (point) {
        var axis = this.getAxis();
        return [
            axis.toGlobalCoord(axis.dataToCoord(point[0])),
            point[1]
        ];
    }
};
module.exports = Single || module.exports;;